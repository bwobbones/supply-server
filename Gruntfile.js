...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    env: {
      test: {
        FRONTEND_MODE: 'backoffice',
        NODE_ENV: 'production',
        DBSTRING : 'mongodb://127.0.0.1:27017/minhr_test',
        DBNAME : 'minhr_test',
        DBHOST : '127.0.0.1',
      ...
      build: {
        NODE_ENV: 'build',
        DBSTRING : 'mongodb://ip-172-31-20-5:27017/minhr_test',
        DBNAME : 'minhr_test',
      ...
      dev: {
        ...
        DBSTRING : 'mongodb://127.0.0.1:27017/minhr',
        DBNAME : 'minhr',
        DBHOST : '127.0.0.1',
        FRONTEND_MODE: 'backoffice',
        DBPORT : 27017,
  ...
  grunt.registerTask('test', function(target) {
    ...
    else if (target === 'protractorChrome') {
      return grunt.task.run([
        'env:test',
        'express:dev',
        'shell:webdriver_update',
